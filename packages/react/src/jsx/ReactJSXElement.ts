 ...
 * 在react18:
 *  <div key="Hi" {...props}/> or <div key="Hi"/> key放在第三个参数 maybeKey 中。
...
export function jsxDEV(
  ...
  // but as an intermediary step, we will use jsxDEV for everything except <div {...props} key="Hi" />,
  // because we aren't currently able to tell if key is explicitly declared to be undefined or not.
  ...
  // 传入的key必须能够转换为string； "" + key 不报错才可以
